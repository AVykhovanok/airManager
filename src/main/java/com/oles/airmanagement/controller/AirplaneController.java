...
public class AirplaneController {
    ...
    @PostMapping("/create")
    public ResponseEntity<AirplaneResponse> createAirplane(@Valid @RequestBody AirplaneRequest airplaneRequest) {
    ...
    public ResponseEntity<AirplaneResponse> updateAirplane(
        @NotNull @PathVariable Long airplaneId, @Valid @RequestBody AirplaneRequest airplaneRequest) {
